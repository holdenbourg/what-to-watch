...
@Component({
  selector: 'app-feed-comment-reply-template',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './feed-comment-reply-template.component.html',
  styleUrl: './feed-comment-reply-template.component.scss'
})
export class FeedCommentReplyTemplateComponent {
