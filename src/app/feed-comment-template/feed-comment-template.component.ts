...
import { FeedCommentReplyTemplateComponent } from '../feed-comment-reply-template/feed-comment-reply-template.component';

@Component({
  selector: 'app-feed-comment-template',
  standalone: true,
  imports: [CommonModule, FeedCommentReplyTemplateComponent],
  templateUrl: './feed-comment-template.component.html',
  styleUrl: './feed-comment-template.component.scss'
})
export class FeedCommentTemplateComponent implements OnInit {
  ...
  populateReplies(comment: CommentModel) {
    ...
    const viewReplies = document.querySelector(`.feed-post-comment-${comment.postId}-${index} .view-replies`);
    const viewMoreReplies = document.querySelector(`.feed-post-comment-${comment.postId}-${index} .view-more-replies`); 
